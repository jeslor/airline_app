  ...
  <div style="margin: auto; background-color: #fff; border-radius: 8px; padding-top: 20px; padding-bottom: 20px; box-shadow: 0 0 10px rgba(0,0,0,0.05);">
    ...
    <div style="font-size: 15px; border: 1px solid #ddd; border-radius: 6px; padding: 20px; background: #fff;">
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 15px;">
        <tr>
          <td style="padding: 10px 0; font-weight: bold;">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fill="#9a0606" d="M12.57 2.26c-.65.29-1.66.85-2.8 1.5L4.31 3a2.2 2.2 0 0 0-.916.064L2.209 3.4c-.1 0-.1.1 0 .14l4.56 2c-1.54.92-2.91 1.76-3.51 2.14a.86.86 0 0 1-.726.088L1.339 7.39a.86.86 0 0 0-.586.002l-.754.308l2.52 2.1a.88.88 0 0 0 .926.128C4.649 9.39 7.819 7.93 10.179 6.7c5.24-2.78 5.82-3.26 5.82-3.7c0-.69-2-1.4-3.43-.74zM0 13h16v1H0z"/></svg>
